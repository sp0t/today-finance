  ...
  return (
    ...
    >
      ...
      <View style={styles.gainerPrice}>
        ...
        {item.priceChangePercentage24H.valueOf() >= 0 && <Text style={[styles.priceChange, {color:'green'}]}><Ionicons name="arrow-up" size={24} color="green" />{item.priceChangePercentage24H.toFixed(2)}%</Text>}
        {item.priceChangePercentage24H.valueOf() < 0 && <Text style={[styles.priceChange, {color:'red'}]}><Ionicons name="arrow-down" size={24} color="red" />{item.priceChangePercentage24H.toFixed(2)}%</Text>}
      </View>
    </View>
  );
};
